...
if (isset($_POST['submit'])) {
    ...
    $stmt->bind_param("sss", $newpassword, $email, $mobno);
...
<head>
    <meta charset="utf-8" />
    <title>VSCMS | Reset Password</title>
    <!-- App css -->
...
<body class="account-pages">
    ...
    <div class="wrapper-page account-page-full">
                ...
                <div class="account-box">
                    <div class="card-box p-5">
                        <h3 class="text-uppercase text-center pb-4">
                            <a href="index.html">
                                <span>VSCMS | Reset Password</span>
                            </a>
                        </h3>
                        <hr color="#000" />
        ...
        <div class="m-t-40 text-center">
            <p class="account-copyright"><?php echo date('Y');?> © Vehicle Service Center Management System</p>
        </div>
    </div>
    <!-- jQuery  -->
